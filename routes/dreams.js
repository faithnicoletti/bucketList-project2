...
router.get('/', dreamsController.index); // Route for incomplete index
router.get('/index-completed', dreamsController.indexCompleted); // Route for completed index
...
router.get('/edit-careerCompleted/:id', dreamsController.editCareerCompleted);
...
router.get('/edit-travelCompleted/:id', dreamsController.editTravelCompleted);
...
router.get('/edit-tasteCompleted/:id', dreamsController.editTasteCompleted);
...
router.get('/edit-hobbyCompleted/:id', dreamsController.editHobbyCompleted);
...
router.get('/edit-fitnessCompleted/:id', dreamsController.editFitnessCompleted);
